...
`git commit --amend -m "новое сообщение"` - данная команда меняет сообщение последнего коммита. При этом хеш коммита изменится, т.к. изменилось сообщение и время коммита
